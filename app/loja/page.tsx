...
export default function LojaPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-century">
      {/* Header da Loja */}
      <header className="bg-black/90 backdrop-blur-sm py-4 sticky top-0 z-50">
        <div className="container mx-auto px-4 flex items-center justify-between">
          <Link href="/" className="flex items-center space-x-2 text-white hover:text-red-600 transition-colors">
            <ArrowLeft className="w-5 h-5" />
            <span className="font-century">Voltar</span>
          </Link>
          <h1 className="text-2xl font-bold font-weezer">
            TEAM RAM<span className="text-red-600">O</span>S STORE
          </h1>
            ...
            {products.map((product) => (
              ...
              >
                ...
                <div className="p-6 text-black">
                  ...
                  <p className="text-center text-xs text-gray-500 mt-3 font-century">
      ...
      <section className="py-20 bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center p-6 border-2 border-red-600 rounded-lg bg-gray-800/50">
      ...
      <footer className="bg-black py-12 border-t border-gray-800">
        <div className="container mx-auto px-4 text-center">
          <h3 className="text-xl font-bold mb-4 font-weezer">
            TEAM RAM<span className="text-red-600">O</span>S STORE
          </h3>
          <p className="text-gray-400 text-sm font-century">© 2025 Team Ramos Store. Todos os direitos reservados.</p>
          <div className="mt-4">
            <Link href="/" className="text-red-600 hover:text-red-500 transition-colors font-century">
